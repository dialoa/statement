...
abstract: |
  This example document recreates in markdown the AMS LaTeX package's
   "Newtheorem andtheoremstyle test" file (`thmtest.pdf`) by Michael Downes
   and Barbara Beeton. 
filters: 
  - statement # must come before quarto
  - quarto
format:
  html:
...
iff 
$$\sigma\geq \sqrt{d_{\max}^2+d_{\min}^2}.$$ {#eq-sdq}
:::
